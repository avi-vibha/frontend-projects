...
- Install bootstrap : npm i bootstrap@5.2.3  and then  import it to App.css (clear the data in App.css)
- Also deleting index.css which was generated by vite
- In main.tsx remove the index.css import and replace it with bootstrap
- Check the browser to see if bootstrap is imported correctly